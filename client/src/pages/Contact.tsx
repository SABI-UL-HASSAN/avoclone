              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                  ...
                  <input 
                    type="text" 
                    id="name"
                    className="w-full px-4 py-2 border border-gray-300 rounded-sm focus:outline-none focus:ring-1 focus:ring-[#FF0000] focus:border-[#FF0000]"
            ...
            <div className="bg-gray-50 p-8 rounded-sm">
              ...
              <div>
                ...
                <div className="flex space-x-4">
                  <a href="#" className="w-10 h-10 rounded-full bg-gray-200 flex items-center justify-center hover:bg-[#FF0000] hover:text-white transition duration-300">
